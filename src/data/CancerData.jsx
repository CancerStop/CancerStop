function capitalizeText(text, delimiter, joinCharacter){
    return text.split(delimiter)
        .map((word, index) =>
            ["a", "an", "the", "in", "and", "of", "b"].includes(word) && index !== 0
...
export const CancerData = ((data) =>
    Object.fromEntries(Object.entries(data)
        .map(([id, cancer]) => [id, {
            ...
            clinical_trials_link: `https://www.clinicaltrials.gov/ct2/results?cond=${cancer.clinical_trials_name ?? capitalizeText(id, "_", "+")}&recrs=e`,
            ...
            search_link: `/search#gsc.q=${cancer.search_name ?? capitalizeText(id, "_", "%20")}`
        }])
    )
)({
	...
	glioblastoma: {
		...
		search_name: '%22Glioblastoma%22%20OR%20%22Glioma%22%20OR%20%22Glioblastoma%20Multiforme%22',
	},
	...
	breast_cancer_and_triple_negative_or_luminal_a: {
		approved_drugs_name: 'breast',
		clinical_trials_name: 'Breast+Cancer&term=%22Triple+Negative%22',
	...
	breast_cancer_and_HER2_enriched: {
		approved_drugs_name: 'breast',
		clinical_trials_name: 'Breast+Cancer&term=%22HER2+Enriched%22',
	...
	adenocarcinoma_in_esophagus: {
		...
		clinical_trials_name: 'Esophageal+Cancer&term=Adenosarcoma',
		survival_curves_id: '600',
		search_name: 'Esophageal%20Cancer%20Adenocarcinoma',
	},
	squamous_cell_carcinoma: {
		approved_drugs_name: 'esophageal',
		clinical_trials_name: 'Esophageal+Cancer&term=%22Squamous+Cell+Carcinoma%22',
