...
export default function FaqPage() {
    return (
        <div className="faq">
            <h1 style={{ textAlign: "center", padding: 30 }}>FAQ</h1>

            <Accordion className="faq_accordionBody" allowMultipleExpanded>
                            ...
                            <AccordionItem className="faq_subAccordion">
                                ...
                                <AccordionItemPanel className="faq_accordionContent">
                                    <p>
                                        ...
                                        explaination of this term can be found <a href="#">here</a>
                                    </p>
                                </AccordionItemPanel>
                            </AccordionItem>
