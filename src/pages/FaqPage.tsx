            ...
            <div>
              ...
              <AccordionItemPanel>
                <AccordionItem className="faq_subAccordion">
                  ...
                  <AccordionItemPanel className="faq_accordionContent">
                    ...
                    <p>
                      ...
                      individual like tissue grading and staging(in case of
                      solid tumors), ECOG score, success of the proposed
                      treatment in clinical trials, besides other factors. These
                      represent typically observed survival rates as culled from
                      the NCI's SEER program.
                    </p>
                    <br />
                    <p>
                      As medical research and technology advances further and
                      the standard of living improves these are very likely to
                      change. Numbers for these curves are for information
                      purposes only. NO RESPONSIBILITY IS CLAIMED WHATSOEVER.
                    </p>
                  </AccordionItemPanel>
                </AccordionItem>
                ...
                <AccordionItem className="faq_subAccordion">
                  ...
                  <AccordionItemPanel className="faq_accordionContent">
                    <p>
                      Currently, the values for a given age are projected from
                      the survival rates presented for specified age ranges in
                      the SEER Registry. Survival rates are presented up to 10
                ...
                <AccordionItem className="faq_subAccordion">
                  ...
                  <AccordionItemPanel className="faq_accordionContent">
                    <p>
                      The source for these data is from the website of NCI's
                      SEER program.
                    </p>
                  </AccordionItemPanel>
                </AccordionItem>
                ...
                <AccordionItem className="faq_subAccordion">
                  ...
                  <AccordionItemPanel className="faq_accordionContent">
                    <p>
                      ...
                      explaination of this term can be found{" "}
                      <a
                        rel="noreferrer"
                        target="_blank"
                        href="https://seer.cancer.gov/explorer/help.html#survival"
                      >
                        here
                      </a>
                    </p>
                ...
                <AccordionItem className="faq_subAccordion">
                  ...
                  <AccordionItemPanel className="faq_accordionContent">
                    <p>
                      ...
                      relevant papers and biomedical literature from sources
            ...
            <div>
              ...
              <AccordionItemPanel>
                <AccordionItem className="faq_subAccordion">
                  ...
                  <AccordionItemPanel className="faq_accordionContent">
                    <p>
                      ...
                      to Clinicaltrials.gov. Herein one is connected to
                      different ongoing clinical trials from around the globe.
                    </p>
                  </AccordionItemPanel>
                </AccordionItem>
                ...
                <AccordionItem className="faq_subAccordion">
                  ...
                  <AccordionItemPanel className="faq_accordionContent">
                    <p>
                      Yes! The feature currently links directly to their site
                      and hence all features that are available therin are made
                      available.
                    </p>
                  </AccordionItemPanel>
                </AccordionItem>
            ...
            <div>
              ...
              <AccordionItemPanel>
                <AccordionItem className="faq_subAccordion">
                  ...
                  <AccordionItemPanel className="faq_accordionContent">
                    <p>
                      Genes & More provides you with more information about a
                      gene and its variants. Currently, this feature connects
                      you to ClinVar(from NCBI). In the future, this could be
                      updated.
                    </p>
                    <br />
                    <p>
                ...
                <AccordionItem className="faq_subAccordion">
                  ...
                  <AccordionItemPanel className="faq_accordionContent">
                    <p>
                      1. For Genes: enter the gene name in HUGO format, e.g.
                      BCOR, NPM1
                    </p>
                    <br />
                    ...
                    <br />
                    <p>
                      a) 'c' for a coding DNA sequence (like 'c.4009C
                      {">"}T')
                    </p>
                    <p>
                      b) 'g' for a genomic sequence (like g.119522C {">"} T)
                    </p>
            ...
            <div>
              ...
              <AccordionItemPanel>
                <AccordionItem className="faq_subAccordion">
                  ...
                  <AccordionItemPanel className="faq_accordionContent">
                    <p>
                      ...
                      for information purposes only. NO RESPONSIBILITY IS
                      CLAIMED WHATSOEVER. Sites and sources used here are from
                      prominently used information sources. These are likely to
                      change and get updated as new features are incorporated.
                    </p>
                  </AccordionItemPanel>
                </AccordionItem>
                ...
                <AccordionItem className="faq_subAccordion">
                  ...
                  <AccordionItemPanel className="faq_accordionContent">
                    <p>
                      YES! You should always speak with your doctor or health
                      care professional for any further guidance. Content
                      provided here is for information purposes only. NO
                      RESPONSIBILITY IS CLAIMED WHATSOEVER.
                    </p>
                  </AccordionItemPanel>
                </AccordionItem>
                ...
                <AccordionItem className="faq_subAccordion">
                  ...
                  <AccordionItemPanel className="faq_accordionContent">
                    <p>
                      Most certainly! Please feel free to reach us anytime and
                      we will be glad to discuss further.
                    </p>
                  </AccordionItemPanel>
                </AccordionItem>
              </AccordionItemPanel>
