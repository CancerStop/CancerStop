							...
							<AccordionItemPanel>
								<AccordionItem className="faq_subAccordion">
									...
									<AccordionItemPanel className="faq_accordionContent">
										...
										<p>
											Actual results from
											graphs may vary based
											on health of the
											individual like tissue
											grading and staging(in
											case of solid tumors),
											ECOG score, success of
										...
										<p>
											...
											further and the
											standard of living
											improves these are very
											likely to change.
											Numbers for these
											curves are for
											information purposes
											only. NO RESPONSIBILITY
											IS CLAIMED WHATSOEVER.
										</p>
									</AccordionItemPanel>
								</AccordionItem>
								...
								<AccordionItem className="faq_subAccordion">
									...
									<AccordionItemPanel className="faq_accordionContent">
										<p>
											...
											projected from the
											survival rates
											presented for specified
											age ranges in the SEER
											Registry. Survival
											rates are presented up
								...
								<AccordionItem className="faq_subAccordion">
									...
									<AccordionItemPanel className="faq_accordionContent">
										<p>
											...
											presented here are
											termed as 'Relative
											Survival by Survival
											Time'. The link to NCI
											SEER's explaination of
								...
								<AccordionItem className="faq_subAccordion">
									...
									<AccordionItemPanel className="faq_accordionContent">
										<p>
											...
											you feel should also be
											included. We will be
											glad to review it and
											add it to our list.
										</p>
									</AccordionItemPanel>
								</AccordionItem>
						...
						<div>
							...
							<AccordionItemPanel>
								<AccordionItem className="faq_subAccordion">
									...
									<AccordionItemPanel className="faq_accordionContent">
										<p>
											This feature links the
											selected cancer on the
											initial page to
											Clinicaltrials.gov.
											Herein one is connected
											to different ongoing
						...
						<div>
							...
							<AccordionItemPanel>
								<AccordionItem className="faq_subAccordion">
									...
									<AccordionItemPanel className="faq_accordionContent">
										...
										<p>
											...
											gene panel reports
											become available to
											everyone who gets their
											genome sequenced. As
											costs for sequencing
											come down further it's
											only time before every
											user needs to access
											services like these to
											determine the course of
											therapy using precision
											medicine.
										</p>
									</AccordionItemPanel>
								</AccordionItem>
								...
								<AccordionItem className="faq_subAccordion">
									...
									<AccordionItemPanel className="faq_accordionContent">
										<p>
											1. For Genes: enter the
											gene name in HUGO
											format, e.g. BCOR, NPM1
										</p>
										<br />
										<p>
											2. For variants: you
											may enter any of these
											values:
										</p>
										<br />
										<p>
											a) 'c' for a coding DNA
											sequence (like 'c.4009C
											{'>'}T')
										</p>
										<p>
											b) 'g' for a genomic
								...
								<AccordionItem className="faq_subAccordion">
									...
									<AccordionItemPanel className="faq_accordionContent">
										<p>
											So long as the input is
											used to get gene info.
											If you need to get
											variant info you need
											to use the HUGO format.
										</p>
									</AccordionItemPanel>
								</AccordionItem>
								...
								<AccordionItem className="faq_subAccordion">
									...
									<AccordionItemPanel className="faq_accordionContent">
										<p>
											...
											RESPONSIBILITY IS
											CLAIMED WHATSOEVER.
											Sites and sources used
											here are from
											prominently used
											information sources.
											These are likely to
											change and get updated
											as new features are
											incorporated.
										</p>
									</AccordionItemPanel>
